...
const Home = () => {  
 ...
 <>
  ...
  <div className="absolute top-[80px] inset-0 flex flex-col justify-center items-start px-4 sm:px-10 md:px-16 lg:px-24 xl:px-32">
    <h1 className="text-[20px] sm:text-4xl md:text-5xl lg:text-5xl 2xl:text-6xl font-semibold mb-1">
    ...
    <p className="text-[11px] sm:text-base md:text-lg lg:text-xl 2xl:text-2xl text-black mb-6">
    ...
    <div className="w-full h-[750px] sm:w-full sm:h-[750px] md:h-[500px] lg:h-[200px] xl:h-[200px] p-4">
      <div className="grid grid-cols-1 absolute lg:top-[670px] lg:left-[40px] xl:top-[600px] xl:left-[220px] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="w-[330px] h-[200px] md:w-[340px] lg:w-[300px] p-4 bg-blue-700 border rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
        ...
        <div className="w-[330px] h-[200px] md:w-[735px] lg:w-[300px] p-4 bg-blue-700 border rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
  ...
  <div className='absolute xl:left-[50%] xl:top-[950px] top-[1600px] m-[30px] sm:left-[30px] md:top-[1650px] md:left-[60px] lg:top-[950px] lg:left-[530px]'>
   ...
   <div className='bg-white h-[450px] xl:h-[500px] md:h-[600px] lg:h-[650px] xl:mb-32 '>
    ...
    <div className="flex items-center  justify-center flex-col xl:h-[400px] md:h-[600px] w-full bg-white ">
      <Swiper
        breakpoints={{
          340: {
            slidesPerView: 2,
        ...
        className="max-w-[90%] w-full lg:max-w-[80%]"
      >
        {ServiceData.map((item) => (
          <SwiperSlide key={item.title}>
            <div className="flex flex-col   gap-6 mb-20 group relative shadow-lg text-white rounded-xl px-6 py-8 h-[230px] w-[165px] lg:h-[400px] lg:w-[270px] xl:w-[340px] overflow-hidden cursor-pointer">
              <div
   ...
   <div className="bg-white xl:h-[400px] xl:w-full " >
    <div className="text-center">
      ...
      <h1 className='text-1xl  sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl  font-semibold'>We are a modern diagnostic and</h1>
      <h1 className='text-1xl sm:text-3xl md:text-4xl lg:text-4xl  xl:text-5xl font-semibold'>treatment centre that provides top quality</h1>
      <h1 className='text-11l sm:text-3xl md:text-4xl lg:text-4xl  xl:text-5xl font-semibold xl:mb-7 mb-3 md:mb-5'>are for every <span class="changecontent  font-semibold xl:text-5xl text-2xl sm:text-3xl md:text-4xl lg:text-4xl "></span></h1>
      <h6 className='xl:text-xl sm:text-[15px] text-[14px] lg:text-[20px] font-semibold xl:mb-2 md:text-[19px] lg:text-1xl'>Piter Bowman</h6>
